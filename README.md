...
<h3 align="center">Simple Crypto Coin List</h3>
...
Here's a blank template to get started: To avoid retyping too much info. Do a search and replace with your text editor for the following: `codetaskforce`, `y-simple-crypto-coin-list`, `twitter_handle`, `linkedin_username`, `email_client`, `email`, `Simple Crypto Coin List`, `project_description`
